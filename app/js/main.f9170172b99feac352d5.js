...
document.addEventListener('DOMContentLoaded', function () {
    ...
    slider.forEach(function (sliderElement) {
        return sliderElement.addEventListener('click', function (e) {
            var _a, _b;
            scrollToPage(+((_b = (_a = sliderElement) === null || _a === void 0 ? void 0 : _a.dataset) === null || _b === void 0 ? void 0 : _b.pageNumber));
        });
    });
});
